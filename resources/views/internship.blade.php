...
@section('content')
    ...
    <div class="bg-light border rounded border-light hero-technology jumbotron py-5 px-4"
         style="
         padding-top: 0px;background: url(assets/img/karytonndev_background.jpg)center;height: 400px;max-width: 100%;">
        <h1 class="hero-title" style="padding-top: 100px;">Internships</h1>
    ...
    <div class="" style="background: #58CCED;width: 100%;max-width: 100%;margin-top: 0; padding-bottom: 150px;">
        <div class="row">
            ...
            <div class="col-md-3" style="padding: 20px; ">
                <div class="card" style="width: 400px; height: 400px;">
                    <div class="card-body">
                        ...
                        <div style="margin-top: 50px"><a href="" class="btn btn-primary">{{$intern->status}}</a></div>
                    </div>
                </div>
            </div>
                @endforeach
