...
@section('content')
    <div class="bg-light border rounded border-light hero-technology jumbotron py-5 px-4"
         style="background: url(&quot;assets/img/BKG%209.png&quot;) center;height: 600px;max-width: 100%;">
        <h1 class="hero-title" style="text-align: left;margin-top: 200px;margin-bottom: 20px;margin-left: 20px;">
            Innovative Solutions To Boost Your Projects</h1>
    ...
    <div class="row clearmargin clearpadding row-image-txt"
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-sm-pull-6" style="padding: 20px;background: #F2F3F4;"><img
                src="assets/img/about-us-300x293.png" class="img-fluid img-responsive" style="margin-left: 200px"></div>
    </div>
{{--    <div class="container">--}}
{{--        <h3 align="center">Services</h3>--}}
{{--        <div class="row">--}}
{{--            <div class="col-md-3 col-sm-12 col-xs-3">--}}
{{--                <div class="card shadow" style="width: 20rem; height: 400px">--}}
{{--                    <div class="inner">--}}
...
{{--    </div>--}}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <h1 style="margin-left: 100px;">Why Choose Us? Your Business Depends on Your Decisions</h1>
                <p style="margin-left: 100px;color: rgba(13,12,12,0.89);font-family: 'Source Sans Pro', sans-serif;font-size: 20px;">
                    At Kep technologies we know building a great brand takes more than just technology - it is about the
